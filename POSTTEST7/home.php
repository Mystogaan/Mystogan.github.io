<?php
    ...
    if(isset($_GET['submit'])) {
        ...
        $sql = "INSERT INTO komen VALUES ('','$comment')";
...
<head>
    ...
    <title>WEBSITE PENJUALAN NOVEL</title>
...
<body>
    ...
    <div class="header-text">
        <h3>Rekomendasi Herrymedia Untukmu</h3>
    </div>
    <div class="container-main">
        <!-- card novel bumi -->
        <div class="card-container">
            <div class="card active" id="card1">
                <img src="assets/bumi.jpg" alt="Bumi">
                <div class="info">
                    <p>Tere Liye</p>
                    <p>Bumi</p>
                    <p>Rp 98.100</p>
            ...
            <div class="modal" id="modal1">
                <div class="modal-content">
                    ...
                    <h2>Bumi</h2>
                    <p>“Namaku Raib, usiaku 15 tahun, kelas sepuluh. Aku anak perempuan seperti kalian, adik-adik kalian, tetangga kalian. Aku punya dua kucing, namanya si Putih dan si Hitam. Mama dan papaku menyenangkan. Guru-guru di sekolahku seru. Teman-temanku baik dan kompak.”
            ...
            <div class="card active" id="card2">
                <img src="assets/bulan.jpg" alt="Bulan">
                <div class="info">
                    <p>Tere Liye</p>
                    <p>Bulan</p>
                    <p>Rp 100.000</p>
            ...
            <div class="modal" id="modal3">
                <div class="modal-content">
                    ...
                    <p>Novel Kudasai
                        ...
                        Akibat tindakan bodohnya, Chaka terpaksa menikahi Twindy, seorang alpha female luar biasa yang memimpin sebuah firma arsitek terkemuka. Chaka yang seumur hidupnya hanya memiliki dua keahlian, yaitu bernapas dan memasak; mau tidak mau harus menjalani kehidupan pernikahan layaknya sedang menjalani tutorial siksa kubur. Selama dua tahun pernikahan, Chaka tidak pernah sekali pun berani melawan Twindy yang galak banget kayak istri mudanya Firaun. Meskipun begitu, Chaka selalu menyayangi Twindy yang menjadi tulang punggung utama di rumah. Chaka sendiri lebih banyak mengurusi pekerjaan sehari-hari di rumah, seperti memasak, mencuci piring, membersihkan WC, menyikat tangki air, dan mengelola kafe, yang mayoritas sahamnya dimiliki oleh Twindy. Semua barang di rumah dan kafe juga adalah milik Twindy, sedangkan barang yang Chaka beli dengan uangnya sendiri hanya sikat gigi dan remote TV. Seolah-olah kehidupan penuh tangis dan tawa itu belum cukup, Chaka tidak sengaja bertemu dengan mantan pacar yang dulu ditinggalkannya untuk menikah dengan Twindy. Segala hal yang belum selesai di antara mereka pun membawa Chaka ke pusaran yang meskipun ia sekuat tenaga berenang menjauh, tetapi ia justru semakin terseret mendekat. Apakah Chaka harus membiarkan dirinya terseret dan tenggelam bersama masa lalunya, atau meraih uluran tangan Twindy yang ternyata sedang mengandung anaknya?
                    </p>
                </div>
            </div>
            <!-- card novel laut -->
            <div class="card active" id="card4">
                <img src="assets/lautbercerita.png" alt="Laut Bercerita">
                <div class="info">
                    <p>Leila S. Chudori</p>
                    <p>Laut Bercerita</p>
                    <p>Rp 100.000</p>
            ...
            <div class="modal" id="modal4">
                <div class="modal-content">
                    ...
                    <p>Buku ini terdiri atas dua bagian, yaitu kisah-kisah tentang kehidupan yang menyoroti aspek sosial, politik, serta keluarga. Penulis berusaha menggambarkan berbagai sisi kehidupan dan kegalauan yang dihadapi setiap karakter dalam novel ini, dengan latar belakang suasana pantai yang menggugah semangat hidup. Dalam novel ini, pembaca diajak merenungkan makna kehidupan serta nilai-nilai kemanusiaan yang sangat berharga.
                    </p>
                </div>
            </div>
            <!-- card novel matahari -->
            <div class="card active" id="card5">
                <img src="assets/malioboro.jpg" alt="Midnight at Malioboro">
                <div class="info">
                    <p>Skysphire</p>
                    <p>Malioboro</p>
                    <p>Rp 99.000</p>
            ...
            <!-- pop up novel malioboro-->
            <div class="modal" id="modal5">
                <div class="modal-content">
                    <span class="close" data-close="modal5">&times;</span>
                    <h2>Midnight At Malioboro</h2>
                    <p>Tengah malam bagi kebanyakan orang adalah waktu terbaik untuk beristirahat dan tidur lelap. Namun tidak demikian bagi sekelompok anak muda yang merindukan perjalanan dan pengalaman berharga yang akan selalu terukir di ingatan. Dalam novel ini, mereka berpetualang mengarungi malam di Malioboro, menjelajahi keindahan kota Yogyakarta dengan segala keceriaan dan keunikannya. Akankah mereka mendapatkan pengalaman yang tak terlupakan di tengah keramaian kota yang tak pernah mati ini?
                    </p>
                </div>
            </div>
            <!-- card novel mashle -->
            <div class="card active" id="card6">
                <img src="assets/mashle02.jpg" alt="Mashle">
                <div class="info">
                    <p>Hajime Komoto</p>
                    <p>Mashle-02</p>
                    <p>Rp 36.000</p>
            ...
            <div class="modal" id="modal6">
                <div class="modal-content">
                    ...
                    <h2>Mashle</h2>
                    <p>Mashle yang dirilis dalam bahasa Inggris dengan judul Mashle: Magic and Muscles, adalah sebuah seri manga yang menceritakan kisah Mash Burnedead, seorang pemuda yang lahir tanpa kekuatan sihir di dunia yang diisi oleh penyihir. Ia bertekad untuk menjadi 'Pahlawan' dengan cara melawan para penyihir dan menunjukkan bahwa kekuatan otot bisa mengalahkan kekuatan sihir. Dengan humor yang konyol dan aksi yang menghibur, Mashle menghadirkan petualangan yang seru bagi para pembacanya.
                    </p>
                </div>
            </div>
            <!-- card matahari -->
            <div class="card active" id="card7">
                <img src="assets/matahari.jpg" alt="Matahari">
                <div class="info">
                    <p>Tere Liye</p>
                    <p>Matahari</p>
                    <p>Rp 101.000</p>
            ...
            <!-- pop up novel matahari -->
            <div class="modal" id="modal7">
                <div class="modal-content">
                    <span class="close" data-close="modal7">&times;</span>
                    <h2>Matahari</h2>
                    <p>Namanya Ali, 15 tahun, kelas X. Di kelasnya, Ali adalah salah satu siswa yang pendiam dan tertutup. Namun ia menyimpan banyak rahasia, termasuk perasaannya kepada Rania, teman sekelasnya yang selalu ceria. Dalam perjalanan hidupnya, Ali belajar tentang cinta, persahabatan, dan bagaimana menghadapi tantangan yang datang. Tere Liye berhasil merangkai kisah yang menyentuh hati dan penuh makna dalam novel ini, menghadirkan pengalaman yang akan membekas di hati para pembacanya.
                    </p>
                </div>
            </div>
            <!-- card novel melangkah -->
            <div class="card active" id="card8">
                <img src="assets/melangkah.jpg" alt="Melangkah">
                <div class="info">
                    <p>Js Khairen</p>
                    <p>Melangkah</p>
                    <p>Rp 95.000</p>
            ...
            <!-- pop up novel melangkah -->
            <div class="modal" id="modal8">
                <div class="modal-content">
                    <span class="close" data-close="modal8">&times;</span>
                    <h2>Melangkah</h2>
                    <p>Novel Melangkah
                        Melangkah adalah novel yang menceritakan tentang perjalanan hidup seorang gadis bernama Aisyah, yang harus menghadapi berbagai rintangan dan tantangan dalam hidupnya. Dengan semangat dan tekad yang kuat, Aisyah berusaha untuk melangkah maju dan menghadapi segala hal yang datang kepadanya. Dalam novel ini, pembaca akan diajak merenungkan makna kehidupan dan belajar dari pengalaman yang dialami oleh Aisyah.
                    </p>
                </div>
            </div>
